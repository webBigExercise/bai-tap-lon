...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__layouts_admin_layout_admin_layout_component__ = __webpack_require__("./src/app/layouts/admin-layout/admin-layout.component.ts");
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["K" /* NgModule */])({
            ...
            declarations: [
                ...
                __WEBPACK_IMPORTED_MODULE_8__layouts_admin_layout_admin_layout_component__["a" /* AdminLayoutComponent */],
            ],
            providers: [],
...
var SidebarComponent = (function () {
    ...
    SidebarComponent.prototype.ngOnInit = function () {
        if (this.actor === 'student') {
            this.menuItems = ROUTES.filter(function (menuItem) { return menuItem.actor === 'student'; });
        }
        else if (this.actor === 'lecturer') {
            this.menuItems = ROUTES.filter(function (menuItem) {
                return (menuItem.actor === 'lecturer' && menuItem.title !== 'StudentDashBoard');
            });
        }
        else if (this.actor === 'partner') {
            this.menuItems = ROUTES.filter(function (menuItem) {
                return (menuItem.actor === 'partner');
            });
        }
    };
