...
var AppModule = /** @class */ (function () {
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["I" /* NgModule */])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_3__app_component__["a" /* AppComponent */], __WEBPACK_IMPORTED_MODULE_5__login_login_component__["a" /* LoginComponent */], __WEBPACK_IMPORTED_MODULE_7__pagenotfound_component__["a" /* PageNotFoundComponent */]
            ],
            imports: [
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("./node_modules/@angular/core/esm5/core.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__student_student_authentication_service__ = __webpack_require__("./src/app/student/student.authentication.service.ts");
...
var LoginComponent = /** @class */ (function () {
    ...
    LoginComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            ...
            providers: [__WEBPACK_IMPORTED_MODULE_1__student_student_authentication_service__["a" /* StudentAuthenticationService */]]
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__student_student_authentication_service__["a" /* StudentAuthenticationService */], __WEBPACK_IMPORTED_MODULE_2__angular_router__["a" /* Router */]])
    ], LoginComponent);
...
/***/ "./src/app/student/student.authentication.service.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return StudentAuthenticationService; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("./node_modules/@angular/core/esm5/core.js");
...
var StudentAuthenticationService = /** @class */ (function () {
    function StudentAuthenticationService(http, router) {
        this.http = http;
        this.router = router;
    }
    StudentAuthenticationService.prototype.saveToken = function (token) {
        localStorage.setItem('student-token', token);
        this.token = token;
    };
    StudentAuthenticationService.prototype.getToken = function () {
        if (!this.token) {
            this.token = localStorage.getItem('student-token');
        }
        return this.token;
    };
    StudentAuthenticationService.prototype.logout = function () {
        this.token = '';
        window.localStorage.removeItem('student-token');
        this.router.navigateByUrl('/');
    };
    StudentAuthenticationService.prototype.request = function (method, type, user) {
        var _this = this;
        var base;
        if (method === 'post') {
    ...
    StudentAuthenticationService.prototype.register = function (user) {
        return this.request('post', 'register', user);
    };
    StudentAuthenticationService.prototype.login = function (user) {
        return this.request('post', 'login', user);
    };
    StudentAuthenticationService.prototype.profile = function () {
        return this.request('get', 'profile');
    };
    StudentAuthenticationService = __decorate([
    ...
    return StudentAuthenticationService;
}());
